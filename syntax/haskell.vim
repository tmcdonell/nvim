...
" Shakespeare Text Templates
syntax region hsShakespeareInterpolation matchgroup=hsShakespeareAntiQuote
  \ start="#{" end="}"
  \ keepend contained contains=TOP

syntax match hsShakespeareBarQQStart /^\s*|/
  \ contained containedin=hsShakespeareBarQQ

syntax match hsShakespeareBarQQuote /\[\$\?\%(sbt\|lbt\)|\%(\_.\%(|]\)\@!\)*\_.|\]/
  \ contains=hsShakespeareBarQQ

syntax match hsShakespeareBarQQ /|\%(\_.\%(|]\)\@!\)*\_.|/hs=s+1,he=e-1
  \ contained containedin=hsShakespeareBarQQuote contains=hsShakespeareInterpolation,hsShakespeareBarQQStart,@Spell

syntax match hsShakespeareQQuote /\[\$\?\%(st\|lt\)|\%(\_.\%(|]\)\@!\)*\_.|\]/
...
if version >= 508 || !exists("did_hs_syntax_inits")
  ...
  HiLink hsQQVarID    Delimiter
  HiLink hsQQVarIDNew Delimiter
  HiLink hsQQEnd      Delimiter
  HiLink hsQQContent  String

  HiLink hsShakespeareBarQQStart Delimiter
  HiLink hsShakespeareBarQQuote  Delimiter
  HiLink hsShakespeareBarQQ      String
  HiLink hsShakespeareQQuote     Delimiter
  HiLink hsShakespeareQQ         String
  HiLink hsShakespeareAntiQuote  PreProc
